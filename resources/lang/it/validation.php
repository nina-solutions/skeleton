...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'ANA_COGNOME' => 'Cognome',
        'ANA_EMAIL' => 'Email',
        'ANA_CELLULARE' => 'Cellulare',
        'AS_TESSERA' => 'Nr. Tessera',
        'UTY_ID' => 'Qualifica',
        'ANA_TWITTER_ACCOUNT' => 'Account Twitter',
        'AS_NOME_TESTATA' => 'Nome testata',
        'AS_ADDRESS' => 'Indirizzo testata',
        'AS_CITY' => 'Citt&agrave; testata',
        'AS_CAP' => 'CAP testata',
        'AS_STATES' => 'Nazionalit&agrave; testata',
        'AS_COUNTRY' => 'Regione testata',
        'AS_EMAIL' => 'E-mail testata',
        'AS_PHONE' => 'Telefono testata',
        'AS_WWW' => 'Sito web testata',
        'ANA_PRIMA_VISITA' => 'Indicare se prima visita',
        'AS_COMUNICAZIONI' => 'Comunicazioni',
        'ANA_CONSENSO' => 'Consenso',
        'ANA_FILENAME1' => 'Lettera d\'incarico',
        'ANA_FILENAME2' => 'Documento d\'identit&agrave;',
        'ANA_FILENAME3' => 'Documento d\'identit&agrave;',
        'ANA_FILENAME4' => 'Servizio fotografico recente',
        'ANA_FILENAME5' => 'Tessera',
    ],
